<template>
  <div class="flex items-center gap-2 my-1">
    ...
    <div class="flexcol justify-between min-w-72 w-full">
      ...
      <div class="mt-1 relative flex overflow-hidden items-center bg-100000mbps bg-opacity-10 w-full min-h-1 h-1">
        <div class="border-transparent border-r-100000mbps border-1px h-full bg-100000mbps bg-opacity-50 duration-100 " :style="`width: ${ disk.used / disk.total * 100 }%`" />
