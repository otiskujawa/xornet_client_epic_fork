<template>
  <button class="flex items-center justify-between gap-4  p-2 cursor-pointer rounded-2px hover:bg-background-300 focus:bg-background-500 focus:text-white hover:text-white text-text" @click="value = !value">
