<template>
  <div
    class="shadowButton py-1.5 px-2.5 flex items-center h-min border border-alpha-0 select-none cursor-pointer justify-between gap-2 flex-row rounded-full duration-100 bg-gray-300"
