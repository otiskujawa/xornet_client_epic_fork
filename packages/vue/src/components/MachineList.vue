  ...
  <div class="w-full h-full overflow-scroll">
    <base-table>
      <template #headers>
        ...
        <base-table-header v-if="state.settings.columns.value.upload" text="Upload" />
        <base-table-header v-if="state.settings.columns.value.temperature" text="Temperature" />
        <base-table-header v-if="state.settings.columns.value.owner" text="Owner" />
        <base-table-header v-if="state.settings.columns.value.status" text="Status" />
        <base-table-header v-if="state.settings.columns.value.action" text="Action" />
      </template>
      <template #rows>
        <tr
        ...
        >
          <th v-if="state.settings.columns.value.hostname">
          ...
          <th v-if="state.settings.columns.value.network_switch">
            <network-switch :interfaces="machine.dynamic_data?.network" />
          </th>
          <th v-if="state.settings.columns.value.download">
          ...
          <th v-if="state.settings.columns.value.upload">
          ...
          <th v-if="state.settings.columns.value.action">
